...
<div class="header <?php if( get_theme_mod( 'fixedheader' ) ) { ?>removed-fixedheader<?php } ?> <?php if( !is_front_page() && !is_home() ){ ?>headerinner<?php } ?>">
        <div class="container">
            ...
            <div class="header-tagline"><span><?php echo $description; ?></span><div class="social-share"><?php echo do_shortcode("[addthis tool=addthis_horizontal_follow_toolbox]"); ?></div></div>
             <div class="hdrright">
             <div class="toggle">
